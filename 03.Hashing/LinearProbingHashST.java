...
public class LinearProbingHashST<Key, Value> {
    ...
    /**
     * Initializes an empty symbol table with the specified initial capacity and the
    ...
    /**
     * Initializes an empty symbol table with the specified initial capacity and a
     * given load factor.
     *
     * @param capacity    the initial capacity
     * @param load_factor the load factor
     */
    public LinearProbingHashST(int capacity, double load_factor) {
        m = capacity;
        n = 0;
