...
public class SeparateChainingHashST<Key, Value> {
    ...
    /**
     * Initializes an empty symbol table with {@code m} chains and a given load factor.
     * 
     * @param m the initial number of chains
     * @param load_factor the load factor
     */
    @SuppressWarnings("unchecked")
    public SeparateChainingHashST(int m, double load_factor) {
        this.m = m;
    ...
    /**
     * Initializes an empty symbol table with {@code m} chains and the default load factor (0.75)
     * 
     * @param m the initial number of chains
     */
     ...
     * old
     * value with the new value if the symbol table already containsKey the
     * specified key.
    ...
    public void put(Key key, Value val) {
        ...
        // double table size if table occupancy has reached the load factor
